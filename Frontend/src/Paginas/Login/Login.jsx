...
const LoginFoodsys = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f6f7fb] font-['Poppins',Arial,sans-serif] text-[#222222]">
      ...
      {/* Footer */}
      <footer className="bg-[#1861c1] text-white pt-10 pb-5 mt-10">
        <div className="max-w-[1150px] mx-auto px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[30px]">
          <div>
            <h3 className="relative text-lg mb-5 pb-[10px] after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-10 after:h-[2px] after:bg-[#42b72a]">
              Foodsys
            </h3>
            ...
            <div className="flex gap-[15px] mt-[15px]">
              <a 
                href="#" 
                aria-label="Facebook"
                className="flex items-center justify-center w-9 h-9 bg-white/10 rounded-full transition-all duration-[350ms] ease-in-out hover:bg-[#42b72a] hover:-translate-y-[3px]"
              >
          ...
          <div>
            ...
            <a href="Index.html" className="block text-white/80 mb-3 no-underline transition-all duration-[350ms] ease-in-out hover:text-white hover:translate-x-[5px]">
              Inicio
            </a>
            <a href="#" className="block text-white/80 mb-3 no-underline transition-all duration-[350ms] ease-in-out hover:text-white hover:translate-x-[5px]">
              Contacto
            </a>
            <a href="#" className="block text-white/80 mb-3 no-underline transition-all duration-[350ms] ease-in-out hover:text-white hover:translate-x-[5px]">
              ¿Qué es foodsys?
          ...
          <div>
            ...
            <p className="text-white/80 mb-3">
              <i className="fas fa-map-marker-alt"></i> Centro Agropecuario La Granja, Tolima
            </p>
            <p className="text-white/80 mb-3">
              <i className="fas fa-phone"></i> +57 (322) 947-3491
            </p>
            <p className="text-white/80 mb-3">
              <i className="fas fa-envelope"></i> foodsys.edu.co
            </p>
          </div>
        </div>
        
        <div className="max-w-[1150px] mx-auto mt-[30px] pt-5 px-5 border-t border-white/10 text-center text-white/70 text-sm">
