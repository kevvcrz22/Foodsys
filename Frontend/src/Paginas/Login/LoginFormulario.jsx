...
const LoginFormulario = ({
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            onChange={Fn_Cambio}
            onBlur={Fn_Blur}
            className={`w-full px-4 py-3 pr-11 rounded-xl border-2 text-sm bg-[#1a1a2e] text-white placeholder-gray-500 focus:outline-none focus:border-[#1861c1] transition-colors ${Cls_Campo(Est_Tocado.contrasena, Err_Campos.contrasena)}`}
          />
  ...
  <Link
    to="/forgotPassword"
    className="text-xs text-[#1861c1] hover:underline"
  >
