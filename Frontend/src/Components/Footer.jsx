const Footer = () => {
  return (
    // lg:pl-64 para que el footer no quede bajo el sidebar en desktop
    <footer className="bg-[#0f3f80] text-white lg:pl-64">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-green-400 text-xs font-semibold uppercase tracking-wider mb-1">
              Contacto
            </span>
            <span className="text-blue-100 text-xs">Centro Agropecuario La Granja, Tolima</span>
            <span className="text-blue-100 text-xs">+57 (322) 947-3491</span>
            <span className="text-blue-100 text-xs">foodsys.edu.co</span>
          </div>

          {/* Social */}
          <div>
            <span className="text-green-400 text-xs font-semibold uppercase tracking-wider block mb-3">
              Redes sociales
            </span>
            <div className="flex gap-3">
              <a
                href="#"
                aria-label="Facebook"
                className="w-8 h-8 rounded-lg bg-white/10 hover:bg-white/25 flex items-center justify-center transition"
              >
