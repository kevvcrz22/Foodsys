      ...
      >
        <div className="flex flex-col h-full bg-blue-100 border-r border-blue-300">
          ...
          <div className="p-6 border-b border-blue-300">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                />
                <h2 className="text-xl font-bold text-gray-700">FoodSys</h2>
              </div>
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            <NavLink to="/supervisor" end className={navLinkClass} onClick={() => setIsOpen(false)}>
              <Home className="w-5 h-5" />
              <span>Inicio</span>
            </NavLink>

            <NavLink to="/supervisor/perfil" className={navLinkClass} onClick={() => setIsOpen(false)}>
              <User className="w-5 h-5" />
              <span>Mi Perfil</span>
            </NavLink>

            <NavLink to="/supervisor/registrar" className={navLinkClass} onClick={() => setIsOpen(false)}>
              <Edit className="w-5 h-5" />
              <span>Registrar</span>
            </NavLink>

            <NavLink to="/supervisor/reportes" className={navLinkClass} onClick={() => setIsOpen(false)}>
