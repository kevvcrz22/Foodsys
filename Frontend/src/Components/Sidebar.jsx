...
// ─── Color de acento del avatar por rol (se mantiene para distinguir roles) ──
  ...
  const renderInterior = () => (
    <div className="flex flex-col h-full bg-white border-r border-gray-200">
      ...
      <div className="p-5 border-b border-gray-100">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-3 min-w-0">
            <div className={`w-11 h-11 flex-shrink-0 flex items-center justify-center ${acento.accent} rounded-full text-white text-lg font-bold shadow`}>
              {inicial}
            </div>
            <div className="min-w-0">
              <p className="text-gray-800 font-semibold text-sm truncate leading-tight">
                {nombreCompleto}
              </p>
              <span className={`inline-block mt-1 text-xs px-2 py-0.5 rounded-full font-medium ${acento.badge} truncate max-w-[130px]`}>
                {rolActivo || "Sin rol"}
              </span>
            </div>
          </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <p className="text-gray-400 text-xs font-semibold uppercase tracking-widest px-4 mb-2">
          Menú
        </p>
          ...
          <>
            <div className="pt-4 pb-2">
              <div className="flex items-center gap-2 px-4">
                ...
                <p className="text-gray-400 text-xs font-semibold uppercase tracking-widest whitespace-nowrap">
                  Base de Datos
                </p>
                <div className="flex-1 border-t border-gray-200" />
              </div>
